...
INSERT INTO `subscription_admin` (`id`, `adm_email`, `adm_password`, `success_message`, `paypal_business_email`, `adm_otp`, `c_name`, `c_phone`, `c_email`, `c_tax`) VALUES
(1, 'admin@admin.com', '$2y$10$dtllVJZBMzAsbt608Vs1sOyi8DCAL4pzqZM/6oZEXoXg6BHOIpale', 'Thanks. Transaction  Completed. We have Emailed you Transaction Details.', NULL, NULL, NULL, NULL, NULL, NULL);
COMMIT;
