...
<div class="app-title">
        <div>
		  ...
		  <p class="text-success">It will show Only Active Items. (Note: If you want to inactive any Item just click Red Ban Button, Item will be inactive & saved into drafts automatically.)</p>
        </div>
