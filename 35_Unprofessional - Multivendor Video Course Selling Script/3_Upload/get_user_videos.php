      ...
      <div class="row mt-n2">
                ...
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    ...
                    <div class="profile-widget-items">
                      ...
                      <div class="profile-widget-item newHover bg-info" data-toggle="tooltip" data-placement="top" title="Videos : <?php echo user_course_count($pdo,$username) ; ?>">
                        <a href="<?php echo BASE_URL ; ?>uservideos/<?php echo $username ; ?>">
                        <div class="profile-widget-item-label newHoverElement text-white"><i class="fas fa-video"></i></div>
                        <div class="profile-widget-item-value newHoverElement text-white"><?php echo user_course_count($pdo,$username) ; ?></div>
                        </a>
                      </div>
        ...
        <div class="row mt-2">
            ...
            <?php if(!empty($_GET['seller'])=='bestseller') { ?> 
                <?php echo grab_uservideos_items_bestseller_default($pdo,$username) ; ?>
                <div class="jQueryMoreUserBestSellerVideos"></div>
            <?php } elseif(!empty($_GET['price'])=='lowest') { ?> 
                <?php echo grab_uservideos_items_lowprice_default($pdo,$username) ; ?>
                <div class="jQueryMoreUserLowestPriceItem"></div>
            <?php } elseif(!empty($_GET['highprice'])=='highest') { ?> 
                <?php echo grab_uservideos_items_highprice_default($pdo,$username) ; ?>
                <div class="jQueryMoreUserHighestPriceItem"></div>
            <?php } elseif(!empty($_GET['rating'])=='top') { ?> 
                <?php echo grab_uservideos_items_highrating_default($pdo,$username) ; ?>
                <div class="jQueryMoreUserHighestRatingItem"></div>
            <?php } else { ?> 
                <?php echo grab_uservideos_items_default($pdo,$username) ; ?>
                <div class="jQueryMoreUserVideos"></div>
            <?php } ?>
        <?php } else { ?>
            <?php echo grab_uservideos_items_default($pdo,$username) ; ?>
            <div class="jQueryMoreUserVideos"></div>
