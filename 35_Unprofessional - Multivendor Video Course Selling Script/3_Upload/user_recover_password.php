        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header justify-content-center"><h4>Recover Password</h4></div>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <a href="<?php echo BASE_URL ; ?>login" class="btn btn-primary btn-lg btn-block mt-2" tabindex="4"><i class="fas fa-unlock"></i> Login</a>
                  </div>
                </form>
              </div>
            </div>
