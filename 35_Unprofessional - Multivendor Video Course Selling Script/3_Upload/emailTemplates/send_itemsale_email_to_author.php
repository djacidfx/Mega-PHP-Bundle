...
<head>
<title>Congrats! You have 1 New Sale</title>
<!--[if !mso]><!-- --> 
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              <tr>
                                 <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                    <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 1px; font-weight: 400; line-height: 0; text-align: center; color: #424549;">[ New Sale ]</div>
                                 </td>
                              </tr>
                           </table>
                        </div>
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                          ...
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #e5e5e6; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 300; line-height: 25px; text-align: left; color:#ffffff;"><br /><br />Hello '.$userfullname.', You have 1 New Sale of Your Item.<br /><br />All the Best Wishes for Your Future Sales.<br /><br /><a href="'.BASE_URL.'video/'.$item_id.'/'.$itemUrlTitle.'"><img src="'.BASE_URL.'mainImg/'.$imageName.'" style="height:auto;width:100%;" width="300" height="auto"></a></div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" vertical-align="middle" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                   <tr>
                                                      <td align="center" bgcolor="#dd2c00" role="presentation" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; border: none; border-radius: 3px; cursor: auto; mso-padding-alt: 10px 25px; background: #8e44ad;" valign="middle"> <a href="'.BASE_URL.'video/'.$item_id.'/'.$itemUrlTitle.'" style="display: inline-block; background: #8e44ad; color: #eee; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank"> View Sold Item</a> </td>
                                                   </tr>
                                                </table>
                                             </td>
