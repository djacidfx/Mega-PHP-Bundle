...
if( !empty($_POST['email']) ){
    ...
    if($responseKeys["success"]) {
         ...
         $checkUser =  $pdo->prepare("SELECT * FROM ot_users WHERE user_email=? and user_blocked = '0'");
         ...
         if($user_ok > 0){
            ...
            $upd = $pdo->prepare("update ot_users set user_otp = '".$otp."' where user_email = '".$email."'") ;
            $upd->execute() ;
            ...
            include("emailTemplates/send_recoverpass_otp_email.php");
