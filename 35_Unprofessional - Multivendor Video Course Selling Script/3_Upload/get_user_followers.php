...
<div class="main-content">
    <section class="section">
      ...
      <div class="row mt-n2">
                ...
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    ...
                    <div class="profile-widget-items">
                      ...
                      <div class="profile-widget-item newHover bg-info" data-toggle="tooltip" data-placement="top" title="Followers : <?php echo count_followers_by_username($pdo,$username) ; ?>" >
                        <a href="<?php echo BASE_URL ; ?>followers/<?php echo $username ; ?>">
                        <div class="profile-widget-item-label newHoverElement text-white"><i class="fas fa-users"></i></div>
                        <div class="profile-widget-item-value newHoverElement text-white"><?php echo count_followers_by_username($pdo,$username) ; ?></div>
                        </a>
                      </div>
        ...
        <div class="row mt-2">
            <div class="col-12 col-md-12 col-lg-12">
                <?php echo grab_follower_list($pdo,$username); ?>
                <div class="jQueryMoreFollower"></div>
            </div>
        </div>
