...
if(isset($_POST['btn_action']))
{
	...
	if($_POST['btn_action'] == 'changeCatStatusToDeactive')
	{
		if(!empty($_POST['catId']) ){
			...
			$categoryId = filter_var($_POST['catId'], FILTER_SANITIZE_NUMBER_INT) ;
                ...
                $upd->execute() ;
				echo "Category is deactivated & All the Blog belongs to this Category is also Deactivated.";
	...
	if($_POST['btn_action'] == 'changeCatStatusToActive')
	{
		if(!empty($_POST['catId']) ){
            ...
            $upd->execute() ;
			echo "Category is activated & All the Blog belongs to this Category is Activated & Live Now.";
		} else {
			echo "Category ID should not be Empty.";
		}
	}
