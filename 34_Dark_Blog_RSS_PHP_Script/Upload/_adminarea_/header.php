    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a class="app-menu__item" href="<?php echo BASE_URL ; ?>" target="_blank"><i class="app-menu__icon fa fa-globe"></i><span class="app-menu__label"> Website View </span></a></li>
          ...
          <li><a class="app-menu__item" href="<?php echo ADMIN_URL ; ?>category.php"><i class="app-menu__icon fa fa-cubes"></i><span class="app-menu__label"> Category</span></a></li>
          <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-rss-square"></i><span class="app-menu__label">Blogs</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
		  	<li><a href="<?php echo ADMIN_URL ; ?>createblog.php" class="app-menu__item"><i class="app-menu__icon fa fa-file-alt"></i><span class="app-menu__label">Create Blog </span></a></li>
		<li><a href="<?php echo ADMIN_URL ; ?>manageblogs.php" class="app-menu__item"><i class="app-menu__icon fa fa-pencil-alt"></i><span class="app-menu__label">Manage Blogs </span></a></li>
		  </ul>
		 </li>		
		<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-comments"></i><span class="app-menu__label">Comments</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
		  	<li><a href="<?php echo ADMIN_URL ; ?>unreplied.php" class="app-menu__item"><i class="app-menu__icon fa fa-times"></i><span class="app-menu__label">Unreplied Comments </span></a></li>
		<li><a href="<?php echo ADMIN_URL ; ?>replied.php" class="app-menu__item"><i class="app-menu__icon fa fa-check"></i><span class="app-menu__label">Replied Comments </span></a></li>
		  </ul>
		 </li>
