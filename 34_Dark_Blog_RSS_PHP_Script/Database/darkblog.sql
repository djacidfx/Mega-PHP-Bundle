...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 27, 2021 at 10:12 AM
...
--
-- Table structure for table `anony_comment`
--

DROP TABLE IF EXISTS `anony_comment`;
...
CREATE TABLE IF NOT EXISTS `anony_post` (
  ...
  `post_trending` tinyint(1) NOT NULL DEFAULT '0',
