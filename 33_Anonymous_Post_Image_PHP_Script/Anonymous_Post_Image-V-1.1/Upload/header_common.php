        ...
        <nav class="navbar navbar-expand-lg " style="background:#343a40 !important">
            ...
            <div class="container-fluid ">
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item d-flex align-items-center"><button class="nav-link btn btn-md btn-warning subscribe text-primary"><i class="fa fa-upload"></i> Post </button></li>
                        ...
                        <div class="tab" role="tabpanel"> 
                            <ul class="nav nav-tabs bg-dark" role="tablist">
                              <li class="nav-item w-100 bg-dark">
                                <a class="nav-link active bg-dark border border-top-0 border-left-0 border-right-0 text-white" href="#live" role="tab" data-toggle="tab"><i class="fa fa-bookmark"></i> Category</a>
                              </li>
                            </ul> 
