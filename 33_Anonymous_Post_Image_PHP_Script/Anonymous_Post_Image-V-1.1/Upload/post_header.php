...
<head>
	...
	<meta property="og:description" content="<?php echo _e(get_post_description($pdo,$postId)) ; ?>" />
	...
	<meta property="og:image" content="<?php echo find_image_for_metatags($pdo,$postId) ; ?>" />
	<meta property="og:image:secure_url" content="<?php echo find_image_for_metatags($pdo,$postId) ; ?>" />
	<meta property="og:image:width" content="1280" />
	<meta property="og:image:height" content="640" />
	<meta property="twitter:card" content="summary_large_image" />
	<meta property="twitter:image" content="<?php echo find_image_for_metatags($pdo,$postId) ; ?>" />
