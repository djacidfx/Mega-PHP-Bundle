...
function get_official_post($pdo){
	$limit = "3";
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status = '1' and post_type = '1' order by id desc " ;
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1'  and post_type = '1' order by id DESC LIMIT ".$limit."";
	...
	if($total > 0) {
	$output .= '<div class="col-lg-12 border border-top-0 border-left-0 border-right-0 border-light mb-3 "><h2 class="text-light"><i class="fa fa-check-circle text-success"></i> Official Posts
				<a class="btn btn-success btn-sm float-right" href="'.BASE_URL.'official"> Browse All</a>
				</h2>
                </div>
				<hr>
				';
	foreach($result as $row)
	{
		...
		$trendingBadge = '<span class="notify-badge bg-warning text-dark newFontTag"><i class="fa fa-check-circle newFontTag"></i>  Official</span>' ;
		$output .= '<div class="col-lg-4  shadow mt-2">
					<div class="card w-100 rounded post-shadow bg-dark text-white">
					'.$trendingBadge.'
					  <div class="card-header bg-dark text-white"><h6 class="card-title">'.$postTitle.'</h6></div>
...
function get_featured_post($pdo){
    $limit = "3" ;
	$query = "SELECT * FROM anony_post WHERE post_status = '1' and post_featured= '1' and post_type = '0' order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
    $total = $statement->rowCount();
    if($total > 0) {
    $output .= '<div class="col-lg-12 border border-top-0 border-left-0 border-right-0 border-light mb-3 mt-3"><h2 class="text-light"><i class="fa fa-diamond text-warning"></i> Featured Posts
...
function get_official_post_default($pdo) {
	...
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status = '1' and post_type = '1'  and post_featured != '1' order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1'  and post_type = '1'  and post_featured != '1' order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
	$total = $statement->rowCount();
	if($total > 0) {
	$output .= '<div class="col-lg-12 border border-top-0 border-left-0 border-right-0 border-light mb-3 mt-3"><h2 class="text-light"><i class="fa fa-check-circle text-success"></i> Official Posts
				</h2>
                </div>
				<hr>
				';
...
function get_official_post_onload($pdo) {
	...
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_type = '1' and post_status='1'  and post_featured != '1' and id < ".$_GET['id']." order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	$output = "";
	...
	$query = "SELECT * FROM anony_post WHERE post_type = '1' and post_status = '1' and post_featured != '1' and id < ".$_GET['id']." order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_featured_post_default($pdo) {
    $limit = get_limit_default($pdo);
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status = '1' and post_type = '0'  and post_featured = '1' order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1'  and post_type = '0'  and post_featured = '1' order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_featured_post_onload($pdo) {
	...
	$limit = get_limit_onload($pdo);
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_type = '0' and post_status='1'  and post_featured = '1' and id < ".$_GET['id']." order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	$output = "";
	...
	$query = "SELECT * FROM anony_post WHERE post_type = '0' and post_status = '1' and post_featured = '1' and id < ".$_GET['id']." order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_user_post_default($pdo){
	...
	$total = $statement->rowCount();
	if($total > 0) {
	$output .= '<div class="col-lg-12 border border-top-0 border-left-0 border-right-0 border-light mb-3 mt-3"><h2 class="text-light"><i class="fa fa-user-secret text-warning"></i> Anonymous Posts
...
function get_single_post($pdo,$postId) {
	...
	foreach($result as $row)
	{
		...
		$postTitle = get_post_title($pdo,$postId) ;
		$postDate = get_post_date($pdo,$postId) ;
		$postImage = '<a href="'.BASE_URL.'postImage/'._e($row['post_image']).'" class="spotlight" data-title="'.$postTitle.'" ><img src="'.BASE_URL.'postImage/'._e($row['post_image']).'" class="img-fluid postBigImage w-100" ></a>' ;
		$output .= '
					<div class="card w-100 rounded post-shadow bg-dark text-white">
					  <div class="card-header bg-dark text-white text-center"><h4 class="card-title">'.$postTitle.'</h4></div>
					  <div class="card-body text-center">
						<h5 class="card-title">'.($postImage).'</h5>
					  </div>
					  <div class="card-footer">
