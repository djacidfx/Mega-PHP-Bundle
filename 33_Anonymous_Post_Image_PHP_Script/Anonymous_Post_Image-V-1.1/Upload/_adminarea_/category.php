...
<div class="app-title">
        <div>
		  ...
		  <p class="text-success">Admin / User must have to choose category before Posting an Image.(Deactivating Category means All Post inside that category will be disabled & Hidden.)</p>
        </div>
