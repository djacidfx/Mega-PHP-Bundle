...
//escape all admin data
	...
	$alreadyLoved = strip_tags($adm['already_liked']) ;
...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="<?php echo ADMIN_URL ; ?>official.php" ><i class="app-menu__icon fa fa-bullhorn"></i><span class="app-menu__label"> Official Post </span></a></li>
