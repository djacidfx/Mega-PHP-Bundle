					...
					<div class="card">
                		...
                		<div class="card-body">
							<form method="post" id="msg_settings" class="msg_settings">
								...
								<div class="form-group">
									<label><i class="fa fa-comment"></i>&ensp; Pending Approval Message </label>
									<input type="text" name="pendingApproval" class="form-control" maxlength="200" required autocomplete="off" value="<?php echo $pendingApproval ; ?>">
