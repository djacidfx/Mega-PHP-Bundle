...
{	
	$query = "SELECT * FROM send_user_sms WHERE 1";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
...
{	
	...
	$lastday = date("Y-m-t") ;
	$query = "SELECT * FROM send_user_sms WHERE sms_date between '".$firstday."' and '".$lastday."'";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
...
{	
	$today = date("Y-m-d") ;
	$query = "SELECT * FROM send_user_sms WHERE sms_date='".$today."'";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
...
{	
	$query = "SELECT * FROM send_nonuser_sms WHERE 1";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
...
{	
	$firstday = date("Y-m-01") ;
	$lastday = date("Y-m-t") ;
	$query = "SELECT * FROM send_nonuser_sms WHERE nonuser_sms_date between '".$firstday."' and '".$lastday."'";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
...
{	
	$today = date("Y-m-d") ;
	$query = "SELECT * FROM send_nonuser_sms WHERE nonuser_sms_date='".$today."'";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$total = $statement->rowCount();
	return _e($total) ;
