...
<div class="app-title">
        <div>
		  ...
		  <p class="text-success">Hassle Free Analysis for Users, User SMS & Non User SMS.</p>
        </div>
...
<div class="row">
 		<div class="col-lg-12 col-md-12">
				<h5 class="border-bottom text-muted">Send SMS to User Analysis</h5>
			</div>
        <div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-comments fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Total SMS</h5>
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-check fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">This Month SMS</h5>
        ...
        <div class="col-md-4 col-lg-4">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-times fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Today SMS</h5>
...
<div class="row">
 		<div class="col-lg-12 col-md-12">
				<h5 class="border-bottom text-muted">Send SMS to Non User Analysis</h5>
			</div>
        <div class="col-md-4 col-lg-4">
