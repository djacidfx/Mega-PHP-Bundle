                		...
                		<div class="card-body">
							...
							<?php $csrf->echoInputField(); ?>
					  		<div class="form-group">
								<label>Mobile*</label>
								<input type="text" class="form-control"  value="<?php echo $customer_mobile ; ?>" name="mobile" maxlength="25" readonly="readonly" >
    				...
    				<div class="modal-body">
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="form-group">
									<label>Mobile*</label>
									<input type="text" name="mobile" id="changepassMob" class="form-control" readonly="readonly" required />
								</div>
								<div class="form-group">
									<label>OTP*</label>
    				...
    				<div class="modal-body">
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="form-group">
									<label>Mobile*</label>
									<input type="text" name="mobile" id="changepasswordmobile" class="form-control" readonly="readonly" value="<?php echo $customer_mobile ; ?>" required />
								</div>
								<div class="form-group">
