...
// Wrong Captcha Error Text : change only inside double inverted comma i.e. "  " means change only Wrong captcha entered. Try again. text
$captchaerrorMessage = "Wrong captcha entered. Try again." ;
...
if(isset($_POST['submit'])){
    ...
    if ($_SESSION['captcha'] == $captcha) {
        ...
        $_SESSION['error'] = '<i class="bi bi-exclamation-triangle me-1"></i>'.$captchaerrorMessage;
    }
}
                    ...
                    <div class="row maxw">
                        ...
                        <div class="card shadow-lg bg-dark text-white">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="password" name="password" class="form-control bg-dark text-white border border-secondary" placeholder="'.$enterPasswordName.'" autocomplete="off" autofocus required>
                                    </div>
                                    <div class="col-lg-6 mt-3">
                                        <img src="captcha.php"  class="captcha-image">
                                    </div>
                                    <div class="col-lg-6 mt-4">
                                        <input type="text" id="captcha" name="captcha" class="form-control bg-dark text-white border border-secondary" autocomplete="off" >
                                    </div>
