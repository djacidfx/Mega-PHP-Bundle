      ...
      <ul class="app-menu">
		...
		<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-cog"></i><span class="app-menu__label"> Settings &ensp;<span class="badge badge-warning badge-pill">Imp</span></span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
			...
			<li><a class="app-menu__item" href="<?php echo ADMIN_URL ; ?>color.php"><i class="app-menu__icon fa fa-columns"></i><span class="app-menu__label">Header / Footer </span></a></li>
		  </ul>
		</li>
		 <li><a href="<?php echo ADMIN_URL ; ?>category.php" class="app-menu__item"><i class="app-menu__icon fa fa-align-left"></i><span class="app-menu__label"> Artist / Category</span></a></li>
		 <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-music"></i><span class="app-menu__label">Music</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
		  	<li><a class="treeview-item"  href="<?php echo ADMIN_URL ; ?>upload.php"><i class="fa fa-upload"></i> &ensp;Upload Music</a></li>
		 	<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>items.php"><i class="fa fa-check"></i> &ensp;Active Music</a></li>
			<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>drafts.php"><i class="fa fa-times"></i> &ensp;&ensp;Draft Music</a></li>
		  </ul>
		 </li>
