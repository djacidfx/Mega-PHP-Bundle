...
function userlang($txt){
    static $userlang = array(
        ...
        "view" => "보다",
        "total_private_note" => "총 개인 메모",      
        "total_unreadprivate_note" => "읽지 않은 총 개인 메모" ,       
        "total_readprivate_note" => "총 읽은 비공개 메모",        
        "total_banned_ip" => "총 차단 사용자 IP",
        "logout" => "로그 아웃",
        "analysis" => "분석",
        "lifetime_notes" => "평생 개인 메모",
        "thismonth_notes" => "이번 달 비공개 메모",
        "today_notes" => "오늘 개인 메모",
