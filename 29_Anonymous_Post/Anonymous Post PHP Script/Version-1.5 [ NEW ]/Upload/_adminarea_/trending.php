...
<div class="app-title">
        <div>
          <h1><i class="fa fa-pencil-alt"></i> Trending Anonymous Posts</h1>
		  <p class="text-success">It will show Only Trending Post.</p>
        </div>
									  ...
									  <div class="tile">
										<div class="tile-body">
											<div class="table-responsive">
												<table class="table table-bordered table-hover" id="manageTrendingTable">
													<thead>
														<tr>
															<th>S.No.</th>
															<th>Post ID</th>
