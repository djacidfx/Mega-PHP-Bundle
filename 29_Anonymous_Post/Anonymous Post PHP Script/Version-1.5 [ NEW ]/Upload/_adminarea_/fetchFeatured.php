...
$Statement = $pdo->prepare("SELECT * FROM anony_post WHERE post_status='1' and post_featured = '1' order by id desc");
$Statement->execute(); 
...
if($total > 0) {
	...
	foreach($result as $row) {
        ...
        $actionBtn = '
                    <button type="button" name="changeUnFeaturedStatus" id="'.$postId.'" class="btn btn-danger btn-block changeUnFeaturedStatus">MakeUnfeatured</button>
                    <br>
