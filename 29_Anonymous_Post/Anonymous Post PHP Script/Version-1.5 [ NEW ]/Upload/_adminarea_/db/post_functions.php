...
function check_newpost_duplicate($pdo,$postTitle,$postId){
	$query = "SELECT * FROM anony_post WHERE  post_title = '".trim($postTitle)."' and id != '".$postId."'";
...
function get_post_badge($pdo,$postId) {
	...
	foreach($result as $row)
	{
        ...
        $popular = _e($row['post_popular']) ;
        
        if($trending == '1'){
            $output = '<span class="notify-badge bg-warning text-dark newFontTag"><i class="fa fa-line-chart newFontTag"></i>  Trending</span>' ;
        }
        if($featured == '1'){
            $output = '<span class="notify-badge bg-warning text-dark newFontTag"><i class="fa fa-bookmark-o newFontTag"></i>  Featured</span>' ;
        }
        if($popular == '1'){
            $output = '<span class="notify-badge bg-warning text-dark newFontTag"><i class="fa fa-fire newFontTag"></i>  Popular</span>' ;
        }
...
function get_other_post($pdo){
	...
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status = '1' order by id desc " ;
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1'  order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_other_post_onload($pdo) {
	...
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status='1'   and id < ".$_GET['id']." order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	$output = "";
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1'  and id < ".$_GET['id']." order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_post_featured($pdo){
	$limit = get_limit_default($pdo);
	...
	if($totalRows > $limit){
		$output .= '<div class="hiddenItem col-lg-12 justify-content-center ap'.$postId.'">
					<div class="show_more_featured_item" id="show_more_featured_item'.$postId.'">
							...
							<div class="col text-center p-2">
							<div id="loader-icon"><img src="'.ADMIN_URL.'images/loader.gif" class="img-fluid img-loader" /></div>
							<button id="'.$postId.'" class="show_more_all_featured btn btn-dark btn-sm">Load More</button>
							</div>
...
function get_post_featured_onload($pdo) {
...
function get_post_trending($pdo){
	$limit = get_limit_default($pdo);
	...
	if($totalRows > $limit){
		$output .= '<div class="hiddenItem col-lg-12 justify-content-center ap'.$postId.'">
					<div class="show_more_trending_item" id="show_more_trending_item'.$postId.'">
							
							<div class="col text-center p-2">
							<div id="loader-icon"><img src="'.ADMIN_URL.'images/loader.gif" class="img-fluid img-loader" /></div>
							<button id="'.$postId.'" class="show_more_all_trending btn btn-dark btn-sm">Load More</button>
							</div>
...
function get_post_trending_onload($pdo) {
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1' and post_trending = '1' and id < ".$_GET['id']." order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
...
function get_post_popular($pdo){
	$limit = get_limit_default($pdo);
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status = '1' and post_popular = '1' order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1' and post_popular = '1'  order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
	...
	if($totalRows > $limit){
		$output .= '<div class="hiddenItem col-lg-12 justify-content-center ap'.$postId.'">
					<div class="show_more_popular_item" id="show_more_popular_item'.$postId.'">
							
							<div class="col text-center p-2">
							<div id="loader-icon"><img src="'.ADMIN_URL.'images/loader.gif" class="img-fluid img-loader" /></div>
							<button id="'.$postId.'" class="show_more_all_popular btn btn-dark btn-sm">Load More</button>
							</div>
...
function get_post_popular_onload($pdo) {

	$limit = get_limit_onload($pdo);
	$sql = "SELECT count(*) as number_rows FROM anony_post WHERE post_status='1'  and post_popular = '1' and id < ".$_GET['id']." order by id desc " ;
	$newitem = $pdo->prepare($sql);
	$newitem->execute(); 
	$items = $newitem->fetchAll(PDO::FETCH_ASSOC);
	$output = "";
	...
	$query = "SELECT * FROM anony_post WHERE post_status = '1' and post_popular = '1' and id < ".$_GET['id']." order by id DESC LIMIT ".$limit."";
	$statement = $pdo->prepare($query);
	$statement->execute();
	$result = $statement->fetchAll();
	$output = '';
