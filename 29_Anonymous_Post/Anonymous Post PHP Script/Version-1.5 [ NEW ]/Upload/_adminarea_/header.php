      ...
      <ul class="app-menu">
		...
		<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-cog"></i><span class="app-menu__label"> Settings &ensp;<span class="badge badge-warning badge-pill">Imp</span></span><i class="treeview-indicator fa fa-angle-right"></i></a>
		 ...
		 <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-pencil-alt"></i><span class="app-menu__label">Post</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
		 	<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>items.php"><i class="fa fa-check"></i> &ensp; Posts</a></li>
		 	<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>featured.php"><i class="fa fa-bookmark"></i>&ensp; Featured Posts</a></li>
		 	<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>trending.php"><i class="fa fa-chart-line"></i>&ensp; Trending Posts</a></li>
		 	<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>popular.php"><i class="fa fa-fire"></i> &ensp; Popular Posts</a></li>
			<li><a class="treeview-item"  href="<?php echo ADMIN_URL; ?>drafts.php"><i class="fa fa-times"></i> &ensp; Deactive Posts</a></li>
		  </ul>
		 </li>
