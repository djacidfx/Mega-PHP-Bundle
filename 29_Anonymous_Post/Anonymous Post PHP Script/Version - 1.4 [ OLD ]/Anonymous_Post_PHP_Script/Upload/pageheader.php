        ...
        <nav class="navbar navbar-expand-lg " style="background:#343a40 !important">
            <div class="search-box">
                ...
                <form id="searchForm" action="<?php echo BASE_URL.'usersearch.php' ; ?>" method="post" role="search" class="bg-dark">
                    <input type="search" placeholder="Search Anonymous Post" class="form-control bg-dark" name="search_keyword">
                </form>
            </div>
                        ...
                        <div class="tab" role="tabpanel"> 
                            <ul class="nav nav-tabs bg-dark" role="tablist">
                              <li class="nav-item w-100 bg-dark">
                                <a class="nav-link active bg-dark border border-top-0 border-left-0 border-right-0 text-white" href="#live" role="tab" data-toggle="tab"><i class="fa fa-line-chart"></i> Trending Posts</a>
                              </li>
                            </ul> 
