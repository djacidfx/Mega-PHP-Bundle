					...
					<div class="card">
                		...
                		<div class="card-body">
							<form method="post" id="paypalemail_validation" class="paypalemail_validation">
								...
								<div class="form-group">
									<label for="oldpass"><i class="fa fa-key"></i> Admin Password*</label>
								...
								<input type="submit" id="email_submit" name="email_submit" class="btn btn-primary text-center form_submit" value="Update Paypal Business Email" />
								</div>
							</form>
                		</div>
           			 </div>
