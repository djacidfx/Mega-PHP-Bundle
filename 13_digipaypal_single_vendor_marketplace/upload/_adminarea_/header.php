...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a href="<?php echo ADMIN_URL; ?>payPalsuccess.php" class="app-menu__item"><i class="app-menu__icon fa fa-plus"></i><span class="app-menu__label"> Paypal Success URL</span></a></li>
