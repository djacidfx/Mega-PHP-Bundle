		...
		<div class="col-lg-12 col-md-12">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="card">
                		<div class="card-header bg-info text-white text-center"><h4> Pay via Paypal</h4></div>
                		<div class="card-body">
						<form action="<?php echo BASE_URL; ?>payments.php" id="payment_form" method="post" >
							<div class="row">
								<div class="col-lg-6 col-md-6">
								...
								<div class="col-lg-12 text-center mt-1">
									...
									<button type="submit" class="btn btn-md btn-info" id="submitBtn">Pay Now <?php echo "&ensp;$ ".$itemAmt ; ?></button>
								</div>
							</div>
						</form>
						</div>
