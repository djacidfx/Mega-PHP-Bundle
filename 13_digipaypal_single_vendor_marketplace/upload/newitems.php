...
<div class="app-title p-2">
	...
	<ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><h1 class="text-muted">&ensp;<i class="fa fa-chevron-circle-right"></i>&ensp;<i>New Items</i></h1></li>
    </ul>
	<div>
   		<label><i class="text-success">Filter By Category</i></label>
		<select name="browsenewitems" class="browsenewitems form-control mt-n2">
...
<div class="newPro">
<?php echo fetch_newallproduct_foruser($pdo) ; ?>
