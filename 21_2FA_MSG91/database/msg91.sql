...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 10, 2020 at 12:38 PM
...
CREATE TABLE IF NOT EXISTS `ot_admin` (
  ...
  `sms_route` varchar(10) DEFAULT NULL,
  `sms_country` varchar(100) DEFAULT NULL,
...
INSERT INTO `ot_admin` (`id`, `email`, `password`, `otp`, `admin_status`, `show_announcement`, `sms_apikey`, `sms_senderid`, `sms_route`, `sms_country`, `sms_template`) VALUES
(1, 'admin@admin.com', '$2y$10$dtllVJZBMzAsbt608Vs1sOyi8DCAL4pzqZM/6oZEXoXg6BHOIpale', NULL, 1, 1, NULL, NULL, NULL, NULL, NULL);
