...
<div class="app-title">
        <div>
          <h1><i class="fa fa-times"></i> Deactive Subscription Plans</h1>
          <p>Add / Edit / Activate Subscription Plans.</p>
        </div>
		   			...
		   			<div class="col-md-12 col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="page-heading"> <h6>Manage Subscription Plans</h6></div>
								<button class="btn btn-success btn-sm  m-1" id="add_subscription"><i class="fa fa-plus-square"></i> Add Subscription Plan</button>
							</div> <!-- /panel-heading -->
									  ...
									  <div class="tile">
										<div class="tile-body">
										  <div class="table-responsive">
											<div class="table-responsive">
												<table class="table table-bordered table-hover" id="managedeactiveSubscriptionTable">
													<thead>
														<tr>
															<th>S.No.</th>
															<th>ID</th>
    		...
    		<form method="post" id="subscription_form">
    			<div class="modal-content">
    				<div class="modal-header">
						<h4 class="modal-title"><i class='fa fa-plus'></i> Add Subscription Plan</h4>
