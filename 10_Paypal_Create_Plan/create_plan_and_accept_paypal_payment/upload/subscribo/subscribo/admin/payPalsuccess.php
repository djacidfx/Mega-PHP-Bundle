		...
		<div class="col-lg-12 col-md-12">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					...
					<div class="card">
                		<div class="card-header bg-secondary text-white text-center"><h4>Paypal Success Message</h4></div>
                		<div class="card-body">
						<form method="post" class="msgForm">
							<div class="form-group">
								...
								<input type="text" name="successmsg" id="successmsg" class="form-control" value="<?php echo $success_message ; ?>"  maxlength="200" >
