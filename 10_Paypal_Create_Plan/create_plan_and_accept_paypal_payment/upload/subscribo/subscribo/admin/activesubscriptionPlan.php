...
<div class="app-title">
        <div>
          <h1><i class="fa fa-check"></i> Active Subscription Plans</h1>
          <p>Add / Edit / Deactivate Subscription Plans.</p>
        </div>
									  ...
									  <div class="tile">
										<div class="tile-body">
										  <div class="table-responsive">
											<div class="table-responsive">
												<table class="table table-bordered table-hover" id="manageactiveSubscriptionTable">
													<thead>
														<tr>
															<th>S.No.</th>
															<th>ID</th>
