...
<head>
    ...
    <title><?php echo PRIVACY_POLICY_PAGE_LINK_TITLE ; ?></title>
    <meta property="og:title" content="<?php echo PRIVACY_POLICY_PAGE_LINK_TITLE ; ?>" />
            ...
            <div class="col-lg-8 mb-2">
                <div class="card shadow-lg">
                    <div class="card-header">
                        <a href="<?php echo BASE_URL ; ?>"><img src="<?php echo BASE_URL ; ?>/logo.png" class="img-fluid"></a>
                        <h3 class="text-muted mt-3"><i class="bi bi-journals ms-1 me-2"></i><?php echo PRIVACY_POLICY_PAGE_LINK_TITLE ; ?></h3>
                        <hr>
                        <div class="row">
                            <a href="<?php echo BASE_URL ; ?>" class="me-2"><i class="bi bi-house me-1"></i>Home</a>
                        </div>
                    </div>
                    <div class="card-body">
                    <!-- Start - Here You can edit your page description - To change paragraph use tag i.e. <p> You description inside this </p>-->
                        <p>
