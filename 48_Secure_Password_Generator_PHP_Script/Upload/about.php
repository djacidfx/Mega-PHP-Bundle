...
<head>
    ...
    <title><?php echo ABOUT_US_PAGE_LINK_TITLE ; ?></title>
    <meta property="og:title" content="<?php echo ABOUT_US_PAGE_LINK_TITLE ; ?>" />
            ...
            <div class="col-lg-8 mb-2">
                <div class="card shadow-lg">
                    <div class="card-header">
                        ...
                        <h3 class="text-muted mt-3"><i class="bi bi-journals ms-1 me-2"></i><?php echo ABOUT_US_PAGE_LINK_TITLE ; ?></h3>
                        <hr>
                        <div class="row">
