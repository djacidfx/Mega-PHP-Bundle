...
<div class="page-content d-flex align-items-stretch">
	<div class="content-inner w-100">
		...
		<div class="col-lg-1"></div>
		<div class="col-lg-6">
		<?php echo preview_video_for_product_page($pdo,$itemId) ; ?>
		...
		<div class="col-lg-4 shadow-lg">
			...
			<div class="col-lg-12 p-1 mt-2 text-left ml-1">
				<div class="row text-center">
					...
					?>
					<div class="col-lg-6"><small class="text-muted">Love</small><br><a href="<?php echo BASE_URL."login/" ; ?>" class=""><i class="fa fa-heart-o text-danger fa-2x"></i> </a></div>
					<?php
					} 
					?>
				</div>
