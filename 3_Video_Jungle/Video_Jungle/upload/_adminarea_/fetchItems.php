	...
	foreach($result as $row) {
		...
		if(empty($screenshot)){
			...
			$screenshot = '<form method="POST" action="'.ADMIN_URL.'download.php" enctype="multipart/form-data">
							...
							<input type="submit" name="SaveScreenshot" value="Download Video Preview" class="btn btn-sm btn-success" ></form>';
		}
		if(empty($mainfile)){
			$mainfile = "";
		} else {
			$mainfile = '<form method="POST" action="'.ADMIN_URL.'download.php" enctype="multipart/form-data">
							...
							<input type="submit" name="SaveMainfile" value="Download Main File" class="btn btn-sm btn-success" ></form>';
		}
		if(empty($preview)){
			$preview = "";
		} else {
			$preview = '<form method="POST" action="'.ADMIN_URL.'download.php" enctype="multipart/form-data">
							...
							<input type="submit" name="SavePreviewfile" value="Download Preview" class="btn btn-sm btn-success" ></form>';
		}
		if(empty($thumbnail)){
			$thumbnail = "";
		} else {
			$thumbnail = '<form method="POST" action="'.ADMIN_URL.'download.php" enctype="multipart/form-data">
							...
							<input type="submit" name="SaveThumbnailfile" value="Download Thumbnail" class="btn btn-sm btn-success" ></form>';
		}
