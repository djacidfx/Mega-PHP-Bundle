    ...
    <div class="col-lg-10 <?php echo colormode('default_text') ; ?> ">
        <div class="row p-0">
            <div class="col-lg-12 mb-3 ">
                <h1 class="text-muted text-center"> <i class="bi bi-signpost-2-fill text-primary"></i> <?php echo userlang('total_private_note') ; ?></h1>
            </div>
            ...
            <div class="table-responsive p-3 <?php echo colormode('bg_color') ; ?> rounded newShadow">
                ...
                <table class="table table-bordered <?php echo colormode('tbl_dark') ; ?> table-hover cell-border manageNotesTable" >
                    <thead>
                        <tr>
