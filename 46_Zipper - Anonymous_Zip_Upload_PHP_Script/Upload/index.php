	...
	<div class="modal-dialog modal-lg">
			<div class="modal-content  <?php echo colormode('bg_color') ; ?> ">
                    ...
                    <div class="modal-body text-start">
                        <form action="<?php echo BASE_URL ; ?>make_zip" method="post" id="uploadImagePass" class="createNotewithPass">
                        <div class="row">
                            <div class="col-lg-12 cp-messages"></div>
                            <div class="col-lg-12">
                                <label class="<?php echo colormode('default_text') ; ?>"><i class="bi bi-file-earmark-zip me-2"></i><?php echo userlang('zip') ; ?> <small>( <?php echo  userlang('max_limit') ; ?> )</small></label>
                                <input class="mt-2 mb-2 form-control uploadFilePass <?php echo colormode('bg_color') ; ?> <?php echo colormode('default_text') ; ?> <?php echo colormode('border') ; ?>" type="file" name="uploadFilePass" id="uploadFilePass" required>
                            </div>
