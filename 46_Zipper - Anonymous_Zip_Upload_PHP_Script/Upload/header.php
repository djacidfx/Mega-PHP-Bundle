...
<div class="col-lg-12 <?php echo colormode('border_bottom') ; ?> ">
    <div class="row text-center">
        <div class="col-lg-12 p-2"><a href="<?php echo BASE_URL ; ?>"><img src="<?php echo BASE_URL ; ?>img/logo.png" class="img-fluid"></a> <a href="<?php echo BASE_URL ; ?>redirect.php?redirect=<?php echo $_SERVER['REQUEST_URI']; ?>&mode=<?php echo colormode('xmode') ; ?>" class="ms-2"><i class="bi bi-lightbulb-fill bigFont <?php echo colormode('default_text') ; ?> ms-2"></i></a>
        ...
        <p class="text-muted pb-0 mb-0"><small><?php echo userlang('self_destruct_text') ; ?></small></p>
        </div>
    </div>
</div>
