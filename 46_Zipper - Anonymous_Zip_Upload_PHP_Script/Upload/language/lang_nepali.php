...
function userlang($txt){
    static $userlang = array(
        "xlan" => "nepali",
        "self_destruct_text" => "एक पटक लिङ्क खोलिएपछि निजी जिप नोट स्व-नष्ट हुनेछ।",
        "note_heading" => "बेनामी निजी जिप नोट",
        "note_heading_password" => "पासवर्डको साथ बेनामी निजी जिप नोट",
        "textarea_placeholder" => "तपाईको निजी नोट के हो ...?",
        "create_note_btn" => "निजी जिप नोट सिर्जना गर्नुहोस्",
        "create_note_with_password_btn" => "पासवर्डको साथ निजी जिप नोट सिर्जना गर्नुहोस्",
        ...
        "note_heading_link" => "बेनामी निजी जिप नोट लिङ्क",
        "note_destroy_msg" => "यो नोट नष्ट भयो। सञ्झ्याल बन्द गर्नु वा भाषा / मोड परिवर्तन गर्नु अघि यसलाई डाउनलोड र प्रतिलिपि गर्नुहोस्।",
        "create_pvt_note" => "आफ्नो निजी नोट सिर्जना गर्नुहोस्",
        "read_msg" => "यो नोट डाउनलोड, पढेर र नष्ट भएको देखिन्छ।",
        "password_heading" => "पासवर्ड",
        "repassword_heading" => "पासवर्ड पुन: लेख्नुहोस",
        "password_msg_heading" => "निजी जिप नोट पासवर्ड इन्क्रिप्टेड छ।",
        ...
        "view" => "हेर्नुहोस्",
        "total_private_note" => "कुल निजी जिप नोटहरू",      
        "total_unreadprivate_note" => "कुल नपढिएका निजी जिप नोटहरू",       
        "total_readprivate_note" => "कुल पढ्ने निजी जिप नोटहरू",        
        "total_banned_ip" => "कुल प्रतिबन्धित प्रयोगकर्ता आईपी",
        "logout" => "बाहिर निस्कनु",
        "analysis" => "विश्लेषण",
        "lifetime_notes" => "आजीवन निजी जिप नोटहरू",
        "thismonth_notes" => "यो महिना निजी जिप नोटहरू",
        "today_notes" => "आजको निजी जिप नोटहरू",
        ...
        "zip" => "जिप फाइल",
        "download" => "Zip डाउनलोड गर्नुहोस्",
        "download_deleted" => "Zip मेटाइयो",
        "delete_temp_zip" => "सबै Temp Zip फाइलहरू मेटाउनुहोस्",
        "delete_temp_zip_success" => "सबै Temp Zip फाइलहरू सफलतापूर्वक मेटाइयो।",
        "note_deleted" => "नोट र जिप सफलतापूर्वक मेटाइयो।",
        "note_deleted_with_ip" => "नोट र जिप सफलतापूर्वक मेटाइयो र प्रयोगकर्ता आईपी ब्लक गरिएको छ।"
    );  
    return $userlang[$txt];
}
