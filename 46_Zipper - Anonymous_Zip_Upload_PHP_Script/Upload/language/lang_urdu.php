...
function userlang($txt){
    static $userlang = array(
        "xlan" => "urdu",
        "self_destruct_text" => "لنک کھلنے کے بعد پرائیویٹ زپ نوٹ خود کو تباہ کر دے گا۔",
        "note_heading" => "گمنام پرائیویٹ زپ نوٹ",
        "note_heading_password" => "پاس ورڈ کے ساتھ گمنام نجی زپ نوٹ",
        "textarea_placeholder" => "آپ کا پرائیویٹ نوٹ کیا ہے...؟",
        "create_note_btn" => "پرائیویٹ زپ نوٹ بنائیں",
        "create_note_with_password_btn" => "پاس ورڈ کے ساتھ پرائیویٹ زپ نوٹ بنائیں",
        ...
        "note_heading_link" => "گمنام نجی زپ نوٹ لنک",
        "note_destroy_msg" => "یہ نوٹ تباہ کر دیا گیا۔ ونڈو بند کرنے یا زبان / موڈ تبدیل کرنے سے پہلے اسے ڈاؤن لوڈ اور کاپی کریں۔",
        "create_pvt_note" => "اپنا پرائیویٹ نوٹ بنائیں",
        "read_msg" => "ایسا لگتا ہے کہ نوٹ ڈاؤن لوڈ، پڑھا اور تباہ کر دیا گیا تھا۔",
        "password_heading" => "پاس ورڈ",
        "repassword_heading" => "دوبارہ پاسوورڈ لکھئے",
        "password_msg_heading" => "پرائیویٹ زپ نوٹ پاس ورڈ انکرپٹڈ ہے۔",
        ...
        "view" => "دیکھیں",
        "total_private_note" => "کل پرائیویٹ زپ نوٹس",      
        "total_unreadprivate_note" => "کل بغیر پڑھے ہوئے پرائیویٹ زپ نوٹس",       
        "total_readprivate_note" => "ٹوٹل ریڈ زپ پرائیویٹ نوٹس",        
        "total_banned_ip" => "کل ممنوعہ صارف IP",
        "logout" => "لاگ آوٹ",
        "analysis" => "تجزیہ",
        "lifetime_notes" => "لائف ٹائم پرائیویٹ زپ نوٹس",
        "thismonth_notes" => "اس مہینے کے پرائیویٹ زپ نوٹس",
        "today_notes" => "آج پرائیویٹ زپ نوٹس",
        ...
        "zip" => "زپ فائل",
        "download" => "زپ ڈاؤن لوڈ کریں۔",
        "download_deleted" => "زپ کو حذف کر دیا گیا۔",
        "delete_temp_zip" => "تمام عارضی زپ فائلوں کو حذف کریں۔",
        "delete_temp_zip_success" => "تمام Temp Zip فائلوں کو کامیابی کے ساتھ حذف کر دیا گیا۔",
        "note_deleted" => "نوٹ اور زپ کامیابی کے ساتھ حذف ہو گئے ہیں۔",
        "note_deleted_with_ip" => "نوٹ اور زپ کو کامیابی کے ساتھ حذف کر دیا گیا ہے اور یوزر آئی پی کو بلاک کر دیا گیا ہے۔"
    );  
    return $userlang[$txt];
}
