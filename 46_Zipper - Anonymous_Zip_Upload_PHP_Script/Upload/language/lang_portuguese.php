...
function userlang($txt){
    static $userlang = array(
        "xlan" => "portuguese",
        "self_destruct_text" => "A nota zip privada se autodestruirá quando o link for aberto.",
        "note_heading" => "Nota postal privada anônima",
        "note_heading_password" => "Nota postal privada anônima com senha",
        "textarea_placeholder" => "Qual é a sua nota particular...?",
        "create_note_btn" => "Criar nota postal privada",
        "create_note_with_password_btn" => "Criar nota zip privada com senha",
        ...
        "note_heading_link" => "Link de nota postal privada anônima",
        "note_destroy_msg" => "Esta nota foi destruída. Faça o download e copie-o antes de fechar a janela ou alterar o idioma / modo.",
        "create_pvt_note" => "Crie sua nota privada",
        "read_msg" => "Parece que a nota foi baixada, lida e destruída.",
        "password_heading" => "Senha",
        "repassword_heading" => "Digite novamente a senha",
        "password_msg_heading" => "Private Zip Note é criptografado por senha.",
        ...
        "view" => "Visualizar",
        "total_private_note" => "Total de CEPs Privados",      
        "total_unreadprivate_note" => "Total de notas postais privadas não lidas",       
        "total_readprivate_note" => "Total Ler Notas Privadas Zip",        
        "total_banned_ip" => "IP total de usuários banidos",
        "logout" => "Sair",
        "analysis" => "Análise",
        "lifetime_notes" => "Notas postais privadas vitalícias",
        "thismonth_notes" => "Notas postais privadas deste mês",
        "today_notes" => "Hoje CEP privado",
        ...
        "zip" => "Arquivo zip",
        "download" => "Baixar zip",
        "download_deleted" => "Zip excluído",
        "delete_temp_zip" => "Excluir todos os arquivos zip temporários",
        "delete_temp_zip_success" => "Todos os arquivos Zip temporários foram excluídos com sucesso.",
        "note_deleted" => "Nota e Zip foram excluídos com sucesso.",
        "note_deleted_with_ip" => "Nota e Zip foram excluídos com sucesso e o Ip do usuário foi bloqueado."
    );  
    return $userlang[$txt];
}
