...
<div class="app-title">
 ...
 <div class="row">
 	<div class="col-lg-12 col-md-12 mt-3">
		<h5 class="border-bottom text-muted"><i class="fa fa-heart text-danger"></i>&ensp;Top 5 Points Holder Image</h5>
	</div>
 ...
 <div class="row mt-4">
 	<div class="col-lg-12 col-md-12 mt-3">
		<h5 class="border-bottom text-muted"><i class="fa fa-heart text-danger"></i>&ensp;Top 5 Winning Image</h5>
	</div>
	<div class="col-lg-12 col-md-12 bg-white rounded p-3">
...
<div class="row mt-4">
 		<div class="col-lg-12 col-md-12">
				<h5 class="border-bottom text-muted">Image Analysis</h5>
			</div>
        <div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-cubes fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Total Images</h5>
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-check fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Active Images</h5>
        ...
        <div class="col-md-4 col-lg-4">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-times fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Deactive Images</h5>
