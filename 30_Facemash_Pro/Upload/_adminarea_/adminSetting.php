							...
							<form method="post" id="admin_settings" class="admin_settings">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="copyrightName" id="copyrightName" maxlength="50"  value="<?php echo $copyrightName ; ?>"required>
										...
										<div class="form-group">
											<label>Default Load*<small>(Means No. of Images shows on Deafault)</small> </label>
											<select name="default_load" class="form-control" required>
												<option value="4" <?php if($defaultLoad == '4'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>4</option>
												<option value="6" <?php if($defaultLoad == '6'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>6</option>
												<option value="8" <?php if($defaultLoad == '8'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>8</option>
												<option value="10" <?php if($defaultLoad == '10'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>10</option>
												<option value="12" <?php if($defaultLoad == '12'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>12</option>
												<option value="14" <?php if($defaultLoad == '14'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>14</option>
											</select>
										</div>
										<div class="form-group">
											<label>On Load*<small>(Means No. of Images shows on When Load More Button Press)</small> </label>
											<select name="on_load" class="form-control" required>
												<option value="4" <?php if($onLoad == '4'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>4</option>
												<option value="6" <?php if($onLoad == '6'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>6</option>
												<option value="8" <?php if($onLoad == '8'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>8</option>
												<option value="10" <?php if($onLoad == '10'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>10</option>
												<option value="12" <?php if($onLoad == '12'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>12</option>
												<option value="14" <?php if($onLoad == '14'){ echo $com = 'selected = "selected" ' ; } else { echo $com = '' ; } ?>>14</option>
											</select>
										</div>
