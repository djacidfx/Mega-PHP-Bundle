...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a href="<?php echo ADMIN_URL; ?>/subscriptionPlan.php" class="header_order app-menu__item"><i class="app-menu__icon  fa fa-arrows-alt"></i><span class="app-menu__label"> Plans</span></a></li>
		...
		<li><a href="<?php echo ADMIN_URL; ?>/Success.php" class="app-menu__item"><i class="app-menu__icon fa fa-plus"></i><span class="app-menu__label"> Success Message</span></a></li>
