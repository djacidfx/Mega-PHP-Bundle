...
<div class="col-lg-12 mt-2">
    <div class="card bg-dark text-white newShadow">
        <div class="card-header text-start">
            <h5><i class="bi bi-slash-circle-fill text-danger"></i> Blocked User IP <button class="openManualBlock ml-2 btn btn-sm btn-danger">+ Manual Block IP</button></h5>
        </div>
    </div>
</div>
<div class="col-lg-12 mt-4">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-dark cell-border" id="manageBlockedTable">
            <thead>
                <tr>
                    <th>S.No.</th>
                    <th>Blocked IP</th>
                ...
                <form method="post" class="blockManualIp">
                    ...
                    <div class="modal-body text-start">
                        <div class="form-group">
                            ...
                            <input type="text" name="userip" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$" class="customBorder form-control bg-dark text-white">
                        </div>
                        <div class="form-group">
