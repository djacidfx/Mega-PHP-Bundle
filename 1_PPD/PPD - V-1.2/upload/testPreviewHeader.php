...
<body>
    <!-- Navbar-->
    <header class="app-header border-bottom bg-light"><a class="app-header__logo text-left bg-light" href="<?php echo BASE_URL ; ?>"><img src="<?php echo BASE_URL ; ?>img/logo.png" class="img-fluid" alt="Logo"></a>
