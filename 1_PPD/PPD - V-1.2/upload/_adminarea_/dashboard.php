...
<div class="row">
		...
		<div class="col-lg-12 col-md-12 mt-3">
			<h5 class="border-bottom text-muted"><i class="fa fa-heart text-danger"></i>&ensp;Top 5 Loved Item</h5>
		</div>
		<div class="col-lg-12 col-md-12 bg-white rounded p-3">
			<canvas id="loveCanvas"></canvas>
		</div>
		<div class="col-lg-12 col-md-12 mt-3">
			<h5 class="border-bottom text-muted"><i class="fa fa-signal text-success"></i>&ensp;Top 5 Viewed Item</h5>
		</div>
		<div class="col-lg-12 col-md-12 bg-white rounded p-3">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-list-ol fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Item Sales</h5>
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-usd fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Actual Earning</h5>
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-list-ol fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Sales</h5>
              <p><b><?php echo count_today_wallet_sale($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-usd fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Earning</h5>
              <p><b><?php echo  count_today_wallet_earning($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-signal fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Top Plan</h5>
              <p><b>
			  <?php 
			  $todayWalletItemId = count_today_biggest_sold_wallet_item($pdo) ;
			  $walletName = get_wallet_plan_name($pdo,$todayWalletItemId) ;
				$strLength = strip_tags($walletName);
				if(strlen($strLength) > 20) {
					$dot = "...";
				} else {
					$dot = "";
				}
				if(!empty($todayWalletItemId)){
				echo strip_tags(substr_replace($strLength, $dot, 20)) ;
				} else {
				echo "No Sale";
				}
			  ?>
...
<div class="row">
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-list-ol fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Sales</h5>
              <p><b><?php echo count_thismonth_wallet_sale($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-usd fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Earning</h5>
              <p><b><?php echo  count_thismonth_wallet_earning($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-signal fa-3x"></i>
            <div class="info">
              ...
              <p><b>
			  <?php 
			  $thismonthWalletItemId = count_thismonth_biggest_sold_wallet_item($pdo) ;
			  $thismonthwalletName = get_wallet_plan_name($pdo,$thismonthWalletItemId) ;
				$strLength = strip_tags($thismonthwalletName);
				if(strlen($strLength) > 20) {
					$dot = "...";
				} else {
					$dot = "";
				}
				if(!empty($thismonthWalletItemId)){
				echo strip_tags(substr_replace($strLength, $dot, 20)) ;
				} else {
				echo "No Sale";
				}
...
<div class="row">
		...
		<div class="col-md-4 col-lg-4">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-list-ol fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Sales</h5>
              <p><b><?php echo count_total_wallet_sale($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
		<div class="col-md-4 col-lg-4">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-usd fa-3x"></i>
            <div class="info">
              <h5 class="font-italic text-muted">Wallet Earning</h5>
              <p><b><?php echo  count_total_wallet_earning($pdo) ; ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-signal fa-3x"></i>
            <div class="info">
              ...
              <p><b>
			  <?php 
			  $totalWalletItemId = count_total_biggest_sold_wallet_item($pdo) ;
			  $totalwalletName = get_wallet_plan_name($pdo,$totalWalletItemId) ;
				$strLength = strip_tags($totalwalletName);
				if(strlen($strLength) > 20) {
					$dot = "...";
				} else {
					$dot = "";
				}
				if(!empty($totalWalletItemId)){
				echo strip_tags(substr_replace($strLength, $dot, 20)) ;
				} else {
				echo "No Sale";
				}
