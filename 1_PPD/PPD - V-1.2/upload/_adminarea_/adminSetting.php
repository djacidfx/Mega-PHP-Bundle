					...
					<div class="card">
                		...
                		<div class="card-body">
							<form method="post" id="admin_settings" class="admin_settings">
								...
								<div class="form-group">
									<label> Admin Email* (Where Admin receives new Emails)</label>
								...
								<div class="form-group">
										...
										<div class="form-group">
											<label>Default Load*<small>(Means No. of Product shows, User Loved Item show, etc)</small> </label>
										...
										<div class="form-group">
											<label>On Load*<small>(No. of Product shows, Loved Item show, etc When Load More Button Press)</small> </label>
