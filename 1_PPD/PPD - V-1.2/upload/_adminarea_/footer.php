...
<script type="text/javascript" src="<?php echo ADMIN_URL ; ?>js/datatables.min.js"></script>
...
<script type="text/javascript" src="<?php echo ADMIN_URL; ?>js/Chart.min.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_URL ; ?>js/topItem.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_URL ; ?>js/admin_user.js"></script>
<script src="<?php echo ADMIN_URL ; ?>tinymce/tinymce.min.js"></script>
<script src="<?php echo ADMIN_URL ; ?>js/tinymce_editor.js"></script>
<?php include("footer_admin_ga.php") ; ?>
</body>
</html>